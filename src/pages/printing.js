...
import fabric from "../assets/productpictures/fabric printing.png"
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">We are one of the</span>{' '}
                <span className="block text-indigo-600 xl:inline">Leading printing and division in Creativity and Innovation</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              Continuously expanding to keep ourselves up to date with the changing trend of the Global Print Industry with a sole commitment of providing better products and service to our print buyers.
              </p>
        ...
        <div role="tabpanel" className="tab-pane" id="related-artists">
            <div className="media-cards">
              <a href="https://forms.gle/gZg4XMoYgWXJG2pk9" target="_blank">
                  ...
                  <div className="media-card__image" style={{backgroundImage: `../assets/productpictures/fabric printing.png`}}>
                    <i className="ion-ios-play" />
                  </div>
                </a><a className="media-card__footer" herf="https://forms.gle/88T8gscZCNMwiKXc6">Fabirc Painting</a>
              </div>
              <a href="https://forms.gle/xmowfCAQFbxstxTs9" target="_blank">
                ...
                </a><a className="media-card__footer">UV Printing</a>
              </div>
              <a href="https://forms.gle/SPhnZsSTtDCf3Nx29" target="_blank">
                ...
                </a><a className="media-card__footer">Ribbon Printing</a>
              </div>
              <a href="hhttps://forms.gle/yHAtoSMzDVkfc5jn6" target="_blank">
                ...
                </a><a className="media-card__footer">Embossing</a>
              </div>
            </div>
          </div>
        </div>
