  ...
  return (
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Hygiene care </span>{' '}
                <span className="block text-indigo-600 xl:inline">at a global level</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              World class hygiene solution provider by being a top-of-mind brand when it comes to hygiene care at a global level in each market that we operate in. 
              </p>
    ...
    <div className="md:mx-auto md:container px-4">
        ...
        <div className="content__middle">
          <h1 style={{fontSize:"40px", fontWeight:"bolder"}}>Curated Categories</h1>
        <div role="tabpanel" className="tab-pane" id="related-artists">
            <div className="media-cards">
              <a href="https://forms.gle/gZg4XMoYgWXJG2pk9" target="_blank">
                ...
                </a><a className="media-card__footer" herf="https://forms.gle/88T8gscZCNMwiKXc6">Printing Services</a>
              </div>
              <a href="https://forms.gle/xmowfCAQFbxstxTs9" target="_blank">
                ...
                </a><a className="media-card__footer">TISSUE PAPER </a>
              </div>
              <a href="https://forms.gle/SPhnZsSTtDCf3Nx29" target="_blank">
                ...
                </a><a className="media-card__footer">CATERING DISPOSABLES </a>
              </div>
              <a href="hhttps://forms.gle/yHAtoSMzDVkfc5jn6" target="_blank">
                ...
                </a><a className="media-card__footer">PPE DISPOSABLES</a>
              </div>
            </div>
          </div>
        </div>
